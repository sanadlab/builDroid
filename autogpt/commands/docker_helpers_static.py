...
def execute_command_in_container(socket, command):    
    ...
    while True:
        try:
            ...
            interrupted = True
            print(f"TIMEOUT: Command '{command}' timed out. Attempting to interrupt with Ctrl+C.")
            ...
            except socket.timeout: # Expected if Ctrl+C worked cleanly
                pass
            ...
            print(f"WARNING: BlockingIOError for '{command}'.")
